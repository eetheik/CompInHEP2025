...
// Fri Apr  4 12:31:20 2025 by ROOT version 6.32.10
// from TTree Events/Events
// found on file: DYJetsToLL_M_50_2022.root
//////////////////////////////////////////////////////////
...
public :
   ...
   TTreeReaderArray<Int_t> Electron_fsrPhotonIdx = {fReader, "Electron_fsrPhotonIdx"};
   ...
   TTreeReaderArray<Bool_t> Electron_mvaIso_WPL = {fReader, "Electron_mvaIso_WPL"};
   ...
   TTreeReaderArray<Bool_t> Electron_mvaNoIso_WPL = {fReader, "Electron_mvaNoIso_WPL"};
   ...
   TTreeReaderArray<Float_t> FatJet_chEmEF = {fReader, "FatJet_chEmEF"};
   TTreeReaderArray<Float_t> FatJet_chHEF = {fReader, "FatJet_chHEF"};
   ...
   TTreeReaderArray<Float_t> FatJet_hfEmEF = {fReader, "FatJet_hfEmEF"};
   TTreeReaderArray<Float_t> FatJet_hfHEF = {fReader, "FatJet_hfHEF"};
   ...
   TTreeReaderArray<Float_t> FatJet_muEF = {fReader, "FatJet_muEF"};
   TTreeReaderArray<Float_t> FatJet_n2b1 = {fReader, "FatJet_n2b1"};
   TTreeReaderArray<Float_t> FatJet_n3b1 = {fReader, "FatJet_n3b1"};
   TTreeReaderArray<Float_t> FatJet_neEmEF = {fReader, "FatJet_neEmEF"};
   TTreeReaderArray<Float_t> FatJet_neHEF = {fReader, "FatJet_neHEF"};
   ...
   TTreeReaderArray<Int_t> FatJet_nConstChHads = {fReader, "FatJet_nConstChHads"};
   TTreeReaderArray<Int_t> FatJet_nConstElecs = {fReader, "FatJet_nConstElecs"};
   TTreeReaderArray<Int_t> FatJet_nConstHFEMs = {fReader, "FatJet_nConstHFEMs"};
   TTreeReaderArray<Int_t> FatJet_nConstHFHads = {fReader, "FatJet_nConstHFHads"};
   TTreeReaderArray<Int_t> FatJet_nConstMuons = {fReader, "FatJet_nConstMuons"};
   TTreeReaderArray<Int_t> FatJet_nConstNeuHads = {fReader, "FatJet_nConstNeuHads"};
   TTreeReaderArray<Int_t> FatJet_nConstPhotons = {fReader, "FatJet_nConstPhotons"};
   ...
   TTreeReaderArray<Int_t> FsrPhoton_electronIdx = {fReader, "FsrPhoton_electronIdx"};
   ...
   TTreeReaderArray<UChar_t> GenJetAK8_nConstituents = {fReader, "GenJetAK8_nConstituents"};
   ...
   TTreeReaderArray<UChar_t> GenJet_nConstituents = {fReader, "GenJet_nConstituents"};
   ...
   TTreeReaderValue<UInt_t> nGenProton = {fReader, "nGenProton"};
   ...
   TTreeReaderValue<UInt_t> nJetCalo = {fReader, "nJetCalo"};
   TTreeReaderArray<Float_t> JetCalo_area = {fReader, "JetCalo_area"};
   TTreeReaderArray<Float_t> JetCalo_emf = {fReader, "JetCalo_emf"};
   TTreeReaderArray<Float_t> JetCalo_eta = {fReader, "JetCalo_eta"};
   TTreeReaderArray<Float_t> JetCalo_mass = {fReader, "JetCalo_mass"};
   TTreeReaderArray<Float_t> JetCalo_phi = {fReader, "JetCalo_phi"};
   TTreeReaderArray<Float_t> JetCalo_pt = {fReader, "JetCalo_pt"};
   TTreeReaderArray<Float_t> JetCalo_rawFactor = {fReader, "JetCalo_rawFactor"};
   TTreeReaderValue<UInt_t> nGenJetAK8ForJEC = {fReader, "nGenJetAK8ForJEC"};
   TTreeReaderArray<Float_t> GenJetAK8ForJEC_eta = {fReader, "GenJetAK8ForJEC_eta"};
   TTreeReaderArray<Float_t> GenJetAK8ForJEC_mass = {fReader, "GenJetAK8ForJEC_mass"};
   TTreeReaderArray<Float_t> GenJetAK8ForJEC_phi = {fReader, "GenJetAK8ForJEC_phi"};
   TTreeReaderArray<Float_t> GenJetAK8ForJEC_pt = {fReader, "GenJetAK8ForJEC_pt"};
   TTreeReaderArray<UChar_t> GenJetAK8ForJEC_nConstituents = {fReader, "GenJetAK8ForJEC_nConstituents"};
   TTreeReaderValue<UInt_t> nFatJetCHS = {fReader, "nFatJetCHS"};
   TTreeReaderArray<Float_t> FatJetCHS_area = {fReader, "FatJetCHS_area"};
   TTreeReaderArray<Float_t> FatJetCHS_chEmEF = {fReader, "FatJetCHS_chEmEF"};
   TTreeReaderArray<Float_t> FatJetCHS_chHEF = {fReader, "FatJetCHS_chHEF"};
   TTreeReaderArray<Float_t> FatJetCHS_eta = {fReader, "FatJetCHS_eta"};
   TTreeReaderArray<Float_t> FatJetCHS_hfEmEF = {fReader, "FatJetCHS_hfEmEF"};
   TTreeReaderArray<Float_t> FatJetCHS_hfHEF = {fReader, "FatJetCHS_hfHEF"};
   TTreeReaderArray<Float_t> FatJetCHS_mass = {fReader, "FatJetCHS_mass"};
   TTreeReaderArray<Float_t> FatJetCHS_muEF = {fReader, "FatJetCHS_muEF"};
   TTreeReaderArray<Float_t> FatJetCHS_neEmEF = {fReader, "FatJetCHS_neEmEF"};
   TTreeReaderArray<Float_t> FatJetCHS_neHEF = {fReader, "FatJetCHS_neHEF"};
   TTreeReaderArray<Float_t> FatJetCHS_phi = {fReader, "FatJetCHS_phi"};
   TTreeReaderArray<Float_t> FatJetCHS_pt = {fReader, "FatJetCHS_pt"};
   TTreeReaderArray<Float_t> FatJetCHS_rawFactor = {fReader, "FatJetCHS_rawFactor"};
   TTreeReaderArray<Int_t> FatJetCHS_jetId = {fReader, "FatJetCHS_jetId"};
   TTreeReaderArray<Int_t> FatJetCHS_nConstChHads = {fReader, "FatJetCHS_nConstChHads"};
   TTreeReaderArray<Int_t> FatJetCHS_nConstElecs = {fReader, "FatJetCHS_nConstElecs"};
   TTreeReaderArray<Int_t> FatJetCHS_nConstHFEMs = {fReader, "FatJetCHS_nConstHFEMs"};
   TTreeReaderArray<Int_t> FatJetCHS_nConstHFHads = {fReader, "FatJetCHS_nConstHFHads"};
   TTreeReaderArray<Int_t> FatJetCHS_nConstMuons = {fReader, "FatJetCHS_nConstMuons"};
   TTreeReaderArray<Int_t> FatJetCHS_nConstNeuHads = {fReader, "FatJetCHS_nConstNeuHads"};
   TTreeReaderArray<Int_t> FatJetCHS_nConstPhotons = {fReader, "FatJetCHS_nConstPhotons"};
   TTreeReaderArray<Int_t> FatJetCHS_nElectrons = {fReader, "FatJetCHS_nElectrons"};
   TTreeReaderArray<Int_t> FatJetCHS_nMuons = {fReader, "FatJetCHS_nMuons"};
   TTreeReaderArray<UChar_t> FatJetCHS_nConstituents = {fReader, "FatJetCHS_nConstituents"};
   TTreeReaderValue<UInt_t> nFatJetForJEC = {fReader, "nFatJetForJEC"};
   TTreeReaderArray<Float_t> FatJetForJEC_area = {fReader, "FatJetForJEC_area"};
   TTreeReaderArray<Float_t> FatJetForJEC_chEmEF = {fReader, "FatJetForJEC_chEmEF"};
   TTreeReaderArray<Float_t> FatJetForJEC_chHEF = {fReader, "FatJetForJEC_chHEF"};
   TTreeReaderArray<Float_t> FatJetForJEC_eta = {fReader, "FatJetForJEC_eta"};
   TTreeReaderArray<Float_t> FatJetForJEC_hfEmEF = {fReader, "FatJetForJEC_hfEmEF"};
   TTreeReaderArray<Float_t> FatJetForJEC_hfHEF = {fReader, "FatJetForJEC_hfHEF"};
   TTreeReaderArray<Float_t> FatJetForJEC_mass = {fReader, "FatJetForJEC_mass"};
   TTreeReaderArray<Float_t> FatJetForJEC_muEF = {fReader, "FatJetForJEC_muEF"};
   TTreeReaderArray<Float_t> FatJetForJEC_neEmEF = {fReader, "FatJetForJEC_neEmEF"};
   TTreeReaderArray<Float_t> FatJetForJEC_neHEF = {fReader, "FatJetForJEC_neHEF"};
   TTreeReaderArray<Float_t> FatJetForJEC_phi = {fReader, "FatJetForJEC_phi"};
   TTreeReaderArray<Float_t> FatJetForJEC_pt = {fReader, "FatJetForJEC_pt"};
   TTreeReaderArray<Float_t> FatJetForJEC_rawFactor = {fReader, "FatJetForJEC_rawFactor"};
   TTreeReaderArray<Int_t> FatJetForJEC_jetId = {fReader, "FatJetForJEC_jetId"};
   TTreeReaderArray<Int_t> FatJetForJEC_nConstChHads = {fReader, "FatJetForJEC_nConstChHads"};
   TTreeReaderArray<Int_t> FatJetForJEC_nConstElecs = {fReader, "FatJetForJEC_nConstElecs"};
   TTreeReaderArray<Int_t> FatJetForJEC_nConstHFEMs = {fReader, "FatJetForJEC_nConstHFEMs"};
   TTreeReaderArray<Int_t> FatJetForJEC_nConstHFHads = {fReader, "FatJetForJEC_nConstHFHads"};
   TTreeReaderArray<Int_t> FatJetForJEC_nConstMuons = {fReader, "FatJetForJEC_nConstMuons"};
   TTreeReaderArray<Int_t> FatJetForJEC_nConstNeuHads = {fReader, "FatJetForJEC_nConstNeuHads"};
   TTreeReaderArray<Int_t> FatJetForJEC_nConstPhotons = {fReader, "FatJetForJEC_nConstPhotons"};
   TTreeReaderArray<Int_t> FatJetForJEC_nElectrons = {fReader, "FatJetForJEC_nElectrons"};
   TTreeReaderArray<Int_t> FatJetForJEC_nMuons = {fReader, "FatJetForJEC_nMuons"};
   TTreeReaderArray<UChar_t> FatJetForJEC_nConstituents = {fReader, "FatJetForJEC_nConstituents"};
   ...
   TTreeReaderArray<Float_t> Jet_btagDeepFlavG = {fReader, "Jet_btagDeepFlavG"};
   TTreeReaderArray<Float_t> Jet_btagDeepFlavQG = {fReader, "Jet_btagDeepFlavQG"};
   TTreeReaderArray<Float_t> Jet_btagDeepFlavUDS = {fReader, "Jet_btagDeepFlavUDS"};
   ...
   TTreeReaderArray<Float_t> Jet_hfEmEF = {fReader, "Jet_hfEmEF"};
   TTreeReaderArray<Float_t> Jet_hfHEF = {fReader, "Jet_hfHEF"};
   ...
   TTreeReaderArray<Float_t> Jet_particleNetAK4_B = {fReader, "Jet_particleNetAK4_B"};
   TTreeReaderArray<Float_t> Jet_particleNetAK4_CvsB = {fReader, "Jet_particleNetAK4_CvsB"};
   TTreeReaderArray<Float_t> Jet_particleNetAK4_CvsL = {fReader, "Jet_particleNetAK4_CvsL"};
   TTreeReaderArray<Float_t> Jet_particleNetAK4_QvsG = {fReader, "Jet_particleNetAK4_QvsG"};
   TTreeReaderArray<Float_t> Jet_particleNetAK4_puIdDisc = {fReader, "Jet_particleNetAK4_puIdDisc"};
   TTreeReaderArray<Float_t> Jet_phi = {fReader, "Jet_phi"};
   TTreeReaderArray<Float_t> Jet_pt = {fReader, "Jet_pt"};
   TTreeReaderArray<Float_t> Jet_puId_beta = {fReader, "Jet_puId_beta"};
   TTreeReaderArray<Float_t> Jet_puId_dR2Mean = {fReader, "Jet_puId_dR2Mean"};
   TTreeReaderArray<Float_t> Jet_puId_frac01 = {fReader, "Jet_puId_frac01"};
   TTreeReaderArray<Float_t> Jet_puId_frac02 = {fReader, "Jet_puId_frac02"};
   TTreeReaderArray<Float_t> Jet_puId_frac03 = {fReader, "Jet_puId_frac03"};
   TTreeReaderArray<Float_t> Jet_puId_frac04 = {fReader, "Jet_puId_frac04"};
   TTreeReaderArray<Float_t> Jet_puId_jetR = {fReader, "Jet_puId_jetR"};
   TTreeReaderArray<Float_t> Jet_puId_jetRchg = {fReader, "Jet_puId_jetRchg"};
   TTreeReaderArray<Float_t> Jet_puId_majW = {fReader, "Jet_puId_majW"};
   TTreeReaderArray<Float_t> Jet_puId_minW = {fReader, "Jet_puId_minW"};
   TTreeReaderArray<Float_t> Jet_puId_ptD = {fReader, "Jet_puId_ptD"};
   TTreeReaderArray<Float_t> Jet_puId_pull = {fReader, "Jet_puId_pull"};
   ...
   TTreeReaderArray<Int_t> Jet_nConstChHads = {fReader, "Jet_nConstChHads"};
   TTreeReaderArray<Int_t> Jet_nConstElecs = {fReader, "Jet_nConstElecs"};
   TTreeReaderArray<Int_t> Jet_nConstHFEMs = {fReader, "Jet_nConstHFEMs"};
   TTreeReaderArray<Int_t> Jet_nConstHFHads = {fReader, "Jet_nConstHFHads"};
   TTreeReaderArray<Int_t> Jet_nConstMuons = {fReader, "Jet_nConstMuons"};
   TTreeReaderArray<Int_t> Jet_nConstNeuHads = {fReader, "Jet_nConstNeuHads"};
   TTreeReaderArray<Int_t> Jet_nConstPhotons = {fReader, "Jet_nConstPhotons"};
   TTreeReaderArray<Int_t> Jet_nElectrons = {fReader, "Jet_nElectrons"};
   TTreeReaderArray<Int_t> Jet_nMuons = {fReader, "Jet_nMuons"};
   TTreeReaderArray<Int_t> Jet_puId_nCharged = {fReader, "Jet_puId_nCharged"};
   ...
   TTreeReaderValue<UInt_t> nJetCHS = {fReader, "nJetCHS"};
   TTreeReaderArray<Float_t> JetCHS_area = {fReader, "JetCHS_area"};
   TTreeReaderArray<Float_t> JetCHS_btagCSVV2 = {fReader, "JetCHS_btagCSVV2"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepB = {fReader, "JetCHS_btagDeepB"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepCvB = {fReader, "JetCHS_btagDeepCvB"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepCvL = {fReader, "JetCHS_btagDeepCvL"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepFlavB = {fReader, "JetCHS_btagDeepFlavB"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepFlavCvB = {fReader, "JetCHS_btagDeepFlavCvB"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepFlavCvL = {fReader, "JetCHS_btagDeepFlavCvL"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepFlavG = {fReader, "JetCHS_btagDeepFlavG"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepFlavQG = {fReader, "JetCHS_btagDeepFlavQG"};
   TTreeReaderArray<Float_t> JetCHS_btagDeepFlavUDS = {fReader, "JetCHS_btagDeepFlavUDS"};
   TTreeReaderArray<Float_t> JetCHS_chEmEF = {fReader, "JetCHS_chEmEF"};
   TTreeReaderArray<Float_t> JetCHS_chFPV0EF = {fReader, "JetCHS_chFPV0EF"};
   TTreeReaderArray<Float_t> JetCHS_chFPV1EF = {fReader, "JetCHS_chFPV1EF"};
   TTreeReaderArray<Float_t> JetCHS_chFPV2EF = {fReader, "JetCHS_chFPV2EF"};
   TTreeReaderArray<Float_t> JetCHS_chFPV3EF = {fReader, "JetCHS_chFPV3EF"};
   TTreeReaderArray<Float_t> JetCHS_chHEF = {fReader, "JetCHS_chHEF"};
   TTreeReaderArray<Float_t> JetCHS_eta = {fReader, "JetCHS_eta"};
   TTreeReaderArray<Float_t> JetCHS_hfEmEF = {fReader, "JetCHS_hfEmEF"};
   TTreeReaderArray<Float_t> JetCHS_hfHEF = {fReader, "JetCHS_hfHEF"};
   TTreeReaderArray<Float_t> JetCHS_hfsigmaEtaEta = {fReader, "JetCHS_hfsigmaEtaEta"};
   TTreeReaderArray<Float_t> JetCHS_hfsigmaPhiPhi = {fReader, "JetCHS_hfsigmaPhiPhi"};
   TTreeReaderArray<Float_t> JetCHS_mass = {fReader, "JetCHS_mass"};
   TTreeReaderArray<Float_t> JetCHS_muEF = {fReader, "JetCHS_muEF"};
   TTreeReaderArray<Float_t> JetCHS_muonSubtrFactor = {fReader, "JetCHS_muonSubtrFactor"};
   TTreeReaderArray<Float_t> JetCHS_neEmEF = {fReader, "JetCHS_neEmEF"};
   TTreeReaderArray<Float_t> JetCHS_neHEF = {fReader, "JetCHS_neHEF"};
   TTreeReaderArray<Float_t> JetCHS_particleNetAK4_B = {fReader, "JetCHS_particleNetAK4_B"};
   TTreeReaderArray<Float_t> JetCHS_particleNetAK4_CvsB = {fReader, "JetCHS_particleNetAK4_CvsB"};
   TTreeReaderArray<Float_t> JetCHS_particleNetAK4_CvsL = {fReader, "JetCHS_particleNetAK4_CvsL"};
   TTreeReaderArray<Float_t> JetCHS_particleNetAK4_QvsG = {fReader, "JetCHS_particleNetAK4_QvsG"};
   TTreeReaderArray<Float_t> JetCHS_particleNetAK4_puIdDisc = {fReader, "JetCHS_particleNetAK4_puIdDisc"};
   TTreeReaderArray<Float_t> JetCHS_phi = {fReader, "JetCHS_phi"};
   TTreeReaderArray<Float_t> JetCHS_pt = {fReader, "JetCHS_pt"};
   TTreeReaderArray<Float_t> JetCHS_puIdDisc = {fReader, "JetCHS_puIdDisc"};
   TTreeReaderArray<Float_t> JetCHS_puId_beta = {fReader, "JetCHS_puId_beta"};
   TTreeReaderArray<Float_t> JetCHS_puId_dR2Mean = {fReader, "JetCHS_puId_dR2Mean"};
   TTreeReaderArray<Float_t> JetCHS_puId_frac01 = {fReader, "JetCHS_puId_frac01"};
   TTreeReaderArray<Float_t> JetCHS_puId_frac02 = {fReader, "JetCHS_puId_frac02"};
   TTreeReaderArray<Float_t> JetCHS_puId_frac03 = {fReader, "JetCHS_puId_frac03"};
   TTreeReaderArray<Float_t> JetCHS_puId_frac04 = {fReader, "JetCHS_puId_frac04"};
   TTreeReaderArray<Float_t> JetCHS_puId_jetR = {fReader, "JetCHS_puId_jetR"};
   TTreeReaderArray<Float_t> JetCHS_puId_jetRchg = {fReader, "JetCHS_puId_jetRchg"};
   TTreeReaderArray<Float_t> JetCHS_puId_majW = {fReader, "JetCHS_puId_majW"};
   TTreeReaderArray<Float_t> JetCHS_puId_minW = {fReader, "JetCHS_puId_minW"};
   TTreeReaderArray<Float_t> JetCHS_puId_ptD = {fReader, "JetCHS_puId_ptD"};
   TTreeReaderArray<Float_t> JetCHS_puId_pull = {fReader, "JetCHS_puId_pull"};
   TTreeReaderArray<Float_t> JetCHS_qgl = {fReader, "JetCHS_qgl"};
   TTreeReaderArray<Float_t> JetCHS_qgl_axis2 = {fReader, "JetCHS_qgl_axis2"};
   TTreeReaderArray<Float_t> JetCHS_qgl_ptD = {fReader, "JetCHS_qgl_ptD"};
   TTreeReaderArray<Float_t> JetCHS_rawFactor = {fReader, "JetCHS_rawFactor"};
   TTreeReaderArray<Int_t> JetCHS_electronIdx1 = {fReader, "JetCHS_electronIdx1"};
   TTreeReaderArray<Int_t> JetCHS_electronIdx2 = {fReader, "JetCHS_electronIdx2"};
   TTreeReaderArray<Int_t> JetCHS_hfadjacentEtaStripsSize = {fReader, "JetCHS_hfadjacentEtaStripsSize"};
   TTreeReaderArray<Int_t> JetCHS_hfcentralEtaStripSize = {fReader, "JetCHS_hfcentralEtaStripSize"};
   TTreeReaderArray<Int_t> JetCHS_jetId = {fReader, "JetCHS_jetId"};
   TTreeReaderArray<Int_t> JetCHS_muonIdx1 = {fReader, "JetCHS_muonIdx1"};
   TTreeReaderArray<Int_t> JetCHS_muonIdx2 = {fReader, "JetCHS_muonIdx2"};
   TTreeReaderArray<Int_t> JetCHS_nConstChHads = {fReader, "JetCHS_nConstChHads"};
   TTreeReaderArray<Int_t> JetCHS_nConstElecs = {fReader, "JetCHS_nConstElecs"};
   TTreeReaderArray<Int_t> JetCHS_nConstHFEMs = {fReader, "JetCHS_nConstHFEMs"};
   TTreeReaderArray<Int_t> JetCHS_nConstHFHads = {fReader, "JetCHS_nConstHFHads"};
   TTreeReaderArray<Int_t> JetCHS_nConstMuons = {fReader, "JetCHS_nConstMuons"};
   TTreeReaderArray<Int_t> JetCHS_nConstNeuHads = {fReader, "JetCHS_nConstNeuHads"};
   TTreeReaderArray<Int_t> JetCHS_nConstPhotons = {fReader, "JetCHS_nConstPhotons"};
   TTreeReaderArray<Int_t> JetCHS_nElectrons = {fReader, "JetCHS_nElectrons"};
   TTreeReaderArray<Int_t> JetCHS_nMuons = {fReader, "JetCHS_nMuons"};
   TTreeReaderArray<Int_t> JetCHS_puId = {fReader, "JetCHS_puId"};
   TTreeReaderArray<Int_t> JetCHS_puId_nCharged = {fReader, "JetCHS_puId_nCharged"};
   TTreeReaderArray<Int_t> JetCHS_qgl_mult = {fReader, "JetCHS_qgl_mult"};
   TTreeReaderArray<UChar_t> JetCHS_nConstituents = {fReader, "JetCHS_nConstituents"};
   ...
   TTreeReaderArray<Int_t> LowPtElectron_electronIdx = {fReader, "LowPtElectron_electronIdx"};
   ...
   TTreeReaderValue<Float_t> Pileup_pthatmax = {fReader, "Pileup_pthatmax"};
   ...
   TTreeReaderArray<Int_t> GenJetAK8ForJEC_partonFlavour = {fReader, "GenJetAK8ForJEC_partonFlavour"};
   TTreeReaderArray<UChar_t> GenJetAK8ForJEC_hadronFlavour = {fReader, "GenJetAK8ForJEC_hadronFlavour"};
   ...
   TTreeReaderArray<Int_t> JetCalo_genJetIdx = {fReader, "JetCalo_genJetIdx"};
   TTreeReaderArray<Int_t> JetCalo_hadronFlavour = {fReader, "JetCalo_hadronFlavour"};
   TTreeReaderArray<Int_t> JetCalo_partonFlavour = {fReader, "JetCalo_partonFlavour"};
   TTreeReaderArray<Int_t> JetCHS_genJetIdx = {fReader, "JetCHS_genJetIdx"};
   TTreeReaderArray<Int_t> JetCHS_hadronFlavour = {fReader, "JetCHS_hadronFlavour"};
   TTreeReaderArray<Int_t> JetCHS_partonFlavour = {fReader, "JetCHS_partonFlavour"};
   TTreeReaderArray<Int_t> FatJetCHS_genJetIdx = {fReader, "FatJetCHS_genJetIdx"};
   TTreeReaderArray<Int_t> FatJetCHS_hadronFlavour = {fReader, "FatJetCHS_hadronFlavour"};
   TTreeReaderArray<Int_t> FatJetCHS_partonFlavour = {fReader, "FatJetCHS_partonFlavour"};
   TTreeReaderArray<Int_t> FatJetForJEC_genJetIdx = {fReader, "FatJetForJEC_genJetIdx"};
   TTreeReaderArray<Int_t> FatJetForJEC_hadronFlavour = {fReader, "FatJetForJEC_hadronFlavour"};
   TTreeReaderArray<Int_t> FatJetForJEC_partonFlavour = {fReader, "FatJetForJEC_partonFlavour"};
   ...
   TTreeReaderArray<UChar_t> LowPtElectron_cleanmask = {fReader, "LowPtElectron_cleanmask"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleEG10_er1p2_dR_Max0p6 = {fReader, "L1_DoubleEG10_er1p2_dR_Max0p6"};
   TTreeReaderValue<Bool_t> L1_DoubleEG10p5_er1p2_dR_Max0p6 = {fReader, "L1_DoubleEG10p5_er1p2_dR_Max0p6"};
   TTreeReaderValue<Bool_t> L1_DoubleEG11_er1p2_dR_Max0p6 = {fReader, "L1_DoubleEG11_er1p2_dR_Max0p6"};
   TTreeReaderValue<Bool_t> L1_DoubleEG4_er1p2_dR_Max0p9 = {fReader, "L1_DoubleEG4_er1p2_dR_Max0p9"};
   TTreeReaderValue<Bool_t> L1_DoubleEG4p5_er1p2_dR_Max0p9 = {fReader, "L1_DoubleEG4p5_er1p2_dR_Max0p9"};
   TTreeReaderValue<Bool_t> L1_DoubleEG5_er1p2_dR_Max0p9 = {fReader, "L1_DoubleEG5_er1p2_dR_Max0p9"};
   TTreeReaderValue<Bool_t> L1_DoubleEG5p5_er1p2_dR_Max0p8 = {fReader, "L1_DoubleEG5p5_er1p2_dR_Max0p8"};
   TTreeReaderValue<Bool_t> L1_DoubleEG6_er1p2_dR_Max0p8 = {fReader, "L1_DoubleEG6_er1p2_dR_Max0p8"};
   TTreeReaderValue<Bool_t> L1_DoubleEG6p5_er1p2_dR_Max0p8 = {fReader, "L1_DoubleEG6p5_er1p2_dR_Max0p8"};
   TTreeReaderValue<Bool_t> L1_DoubleEG7_er1p2_dR_Max0p8 = {fReader, "L1_DoubleEG7_er1p2_dR_Max0p8"};
   TTreeReaderValue<Bool_t> L1_DoubleEG7p5_er1p2_dR_Max0p7 = {fReader, "L1_DoubleEG7p5_er1p2_dR_Max0p7"};
   TTreeReaderValue<Bool_t> L1_DoubleEG8_er1p2_dR_Max0p7 = {fReader, "L1_DoubleEG8_er1p2_dR_Max0p7"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleEG8p5_er1p2_dR_Max0p7 = {fReader, "L1_DoubleEG8p5_er1p2_dR_Max0p7"};
   TTreeReaderValue<Bool_t> L1_DoubleEG9_er1p2_dR_Max0p7 = {fReader, "L1_DoubleEG9_er1p2_dR_Max0p7"};
   TTreeReaderValue<Bool_t> L1_DoubleEG9p5_er1p2_dR_Max0p6 = {fReader, "L1_DoubleEG9p5_er1p2_dR_Max0p6"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleEG_LooseIso16_LooseIso12_er1p5 = {fReader, "L1_DoubleEG_LooseIso16_LooseIso12_er1p5"};
   TTreeReaderValue<Bool_t> L1_DoubleEG_LooseIso18_LooseIso12_er1p5 = {fReader, "L1_DoubleEG_LooseIso18_LooseIso12_er1p5"};
   TTreeReaderValue<Bool_t> L1_DoubleEG_LooseIso20_10_er2p5 = {fReader, "L1_DoubleEG_LooseIso20_10_er2p5"};
   TTreeReaderValue<Bool_t> L1_DoubleEG_LooseIso20_LooseIso12_er1p5 = {fReader, "L1_DoubleEG_LooseIso20_LooseIso12_er1p5"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleEG_LooseIso22_LooseIso12_er1p5 = {fReader, "L1_DoubleEG_LooseIso22_LooseIso12_er1p5"};
   TTreeReaderValue<Bool_t> L1_DoubleEG_LooseIso25_12_er2p5 = {fReader, "L1_DoubleEG_LooseIso25_12_er2p5"};
   TTreeReaderValue<Bool_t> L1_DoubleEG_LooseIso25_LooseIso12_er1p5 = {fReader, "L1_DoubleEG_LooseIso25_LooseIso12_er1p5"};
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau26er2p1_Jet55_RmOvlp_dR0p5 = {fReader, "L1_DoubleIsoTau26er2p1_Jet55_RmOvlp_dR0p5"};
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau26er2p1_Jet70_RmOvlp_dR0p5 = {fReader, "L1_DoubleIsoTau26er2p1_Jet70_RmOvlp_dR0p5"};
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau28er2p1 = {fReader, "L1_DoubleIsoTau28er2p1"};
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau28er2p1_Mass_Max80 = {fReader, "L1_DoubleIsoTau28er2p1_Mass_Max80"};
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau28er2p1_Mass_Max90 = {fReader, "L1_DoubleIsoTau28er2p1_Mass_Max90"};
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau30er2p1 = {fReader, "L1_DoubleIsoTau30er2p1"};
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau30er2p1_Mass_Max80 = {fReader, "L1_DoubleIsoTau30er2p1_Mass_Max80"};
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau30er2p1_Mass_Max90 = {fReader, "L1_DoubleIsoTau30er2p1_Mass_Max90"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau35er2p1 = {fReader, "L1_DoubleIsoTau35er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleJet35_Mass_Min450_IsoTau45er2p1_RmOvlp_dR0p5 = {fReader, "L1_DoubleJet35_Mass_Min450_IsoTau45er2p1_RmOvlp_dR0p5"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleLLPJet40 = {fReader, "L1_DoubleLLPJet40"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu0_Upt15_Upt7 = {fReader, "L1_DoubleMu0_Upt15_Upt7"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_Upt5_Upt5 = {fReader, "L1_DoubleMu0_Upt5_Upt5"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_Upt6_IP_Min1_Upt4 = {fReader, "L1_DoubleMu0_Upt6_IP_Min1_Upt4"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_dR_Max1p6_Jet90er2p5_dR_Max0p8 = {fReader, "L1_DoubleMu0_dR_Max1p6_Jet90er2p5_dR_Max0p8"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0er1p4_OQ_OS_dEta_Max1p6 = {fReader, "L1_DoubleMu0er1p4_OQ_OS_dEta_Max1p6"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p5 = {fReader, "L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p5"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p6 = {fReader, "L1_DoubleMu0er2p0_SQ_OS_dEta_Max1p6"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0er2p0_SQ_OS_dR_Max1p4 = {fReader, "L1_DoubleMu0er2p0_SQ_OS_dR_Max1p4"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0er2p0_SQ_dEta_Max1p5 = {fReader, "L1_DoubleMu0er2p0_SQ_dEta_Max1p5"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0er2p0_SQ_dEta_Max1p6 = {fReader, "L1_DoubleMu0er2p0_SQ_dEta_Max1p6"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0er2p0_SQ_dR_Max1p4 = {fReader, "L1_DoubleMu0er2p0_SQ_dR_Max1p4"};
   TTreeReaderValue<Bool_t> L1_DoubleMu18er2p1_SQ = {fReader, "L1_DoubleMu18er2p1_SQ"};
   TTreeReaderValue<Bool_t> L1_DoubleMu3_OS_er2p3_Mass_Max14_DoubleEG7p5_er2p1_Mass_Max20 = {fReader, "L1_DoubleMu3_OS_er2p3_Mass_Max14_DoubleEG7p5_er2p1_Mass_Max20"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu3er2p0_SQ_OS_dR_Max1p4 = {fReader, "L1_DoubleMu3er2p0_SQ_OS_dR_Max1p4"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu4p5er2p0_SQ_OS_Mass_7to18 = {fReader, "L1_DoubleMu4p5er2p0_SQ_OS_Mass_7to18"};
   TTreeReaderValue<Bool_t> L1_DoubleMu4p5er2p0_SQ_OS_Mass_Min7 = {fReader, "L1_DoubleMu4p5er2p0_SQ_OS_Mass_Min7"};
   TTreeReaderValue<Bool_t> L1_DoubleMu5_OS_er2p3_Mass_8to14_DoubleEG3er2p1_Mass_Max20 = {fReader, "L1_DoubleMu5_OS_er2p3_Mass_8to14_DoubleEG3er2p1_Mass_Max20"};
   TTreeReaderValue<Bool_t> L1_DoubleMu5_SQ_EG9er2p5 = {fReader, "L1_DoubleMu5_SQ_EG9er2p5"};
   TTreeReaderValue<Bool_t> L1_DoubleMu8_SQ = {fReader, "L1_DoubleMu8_SQ"};
   ...
   TTreeReaderValue<Bool_t> L1_ETMHF70 = {fReader, "L1_ETMHF70"};
   TTreeReaderValue<Bool_t> L1_ETMHF70_HTT60er = {fReader, "L1_ETMHF70_HTT60er"};
   TTreeReaderValue<Bool_t> L1_ETMHF80 = {fReader, "L1_ETMHF80"};
   TTreeReaderValue<Bool_t> L1_ETMHF80_HTT60er = {fReader, "L1_ETMHF80_HTT60er"};
   TTreeReaderValue<Bool_t> L1_ETMHF90 = {fReader, "L1_ETMHF90"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_HTT60er = {fReader, "L1_ETMHF90_HTT60er"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_SingleJet60er2p5_dPhi_Min2p1 = {fReader, "L1_ETMHF90_SingleJet60er2p5_dPhi_Min2p1"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_SingleJet60er2p5_dPhi_Min2p6 = {fReader, "L1_ETMHF90_SingleJet60er2p5_dPhi_Min2p6"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_SingleJet80er2p5_dPhi_Min2p1 = {fReader, "L1_ETMHF90_SingleJet80er2p5_dPhi_Min2p1"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_SingleJet80er2p5_dPhi_Min2p6 = {fReader, "L1_ETMHF90_SingleJet80er2p5_dPhi_Min2p6"};
   ...
   TTreeReaderValue<Bool_t> L1_HTT120_SingleLLPJet40 = {fReader, "L1_HTT120_SingleLLPJet40"};
   TTreeReaderValue<Bool_t> L1_HTT120er = {fReader, "L1_HTT120er"};
   TTreeReaderValue<Bool_t> L1_HTT160_SingleLLPJet50 = {fReader, "L1_HTT160_SingleLLPJet50"};
   TTreeReaderValue<Bool_t> L1_HTT160er = {fReader, "L1_HTT160er"};
   TTreeReaderValue<Bool_t> L1_HTT200_SingleLLPJet60 = {fReader, "L1_HTT200_SingleLLPJet60"};
   TTreeReaderValue<Bool_t> L1_HTT200er = {fReader, "L1_HTT200er"};
   TTreeReaderValue<Bool_t> L1_HTT240_SingleLLPJet70 = {fReader, "L1_HTT240_SingleLLPJet70"};
   TTreeReaderValue<Bool_t> L1_HTT255er = {fReader, "L1_HTT255er"};
   TTreeReaderValue<Bool_t> L1_HTT280er = {fReader, "L1_HTT280er"};
   TTreeReaderValue<Bool_t> L1_HTT280er_QuadJet_70_55_40_35_er2p5 = {fReader, "L1_HTT280er_QuadJet_70_55_40_35_er2p5"};
   TTreeReaderValue<Bool_t> L1_HTT320er = {fReader, "L1_HTT320er"};
   TTreeReaderValue<Bool_t> L1_HTT320er_QuadJet_70_55_40_40_er2p5 = {fReader, "L1_HTT320er_QuadJet_70_55_40_40_er2p5"};
   ...
   TTreeReaderValue<Bool_t> L1_IsoTau52er2p1_QuadJet36er2p5 = {fReader, "L1_IsoTau52er2p1_QuadJet36er2p5"};
   ...
   TTreeReaderValue<Bool_t> L1_MinimumBiasHF0 = {fReader, "L1_MinimumBiasHF0"};
   ...
   TTreeReaderValue<Bool_t> L1_Mu18er2p1_Tau26er2p1_Jet55 = {fReader, "L1_Mu18er2p1_Tau26er2p1_Jet55"};
   TTreeReaderValue<Bool_t> L1_Mu18er2p1_Tau26er2p1_Jet70 = {fReader, "L1_Mu18er2p1_Tau26er2p1_Jet70"};
   TTreeReaderValue<Bool_t> L1_Mu20_EG10er2p5 = {fReader, "L1_Mu20_EG10er2p5"};
   TTreeReaderValue<Bool_t> L1_Mu22er2p1_IsoTau28er2p1 = {fReader, "L1_Mu22er2p1_IsoTau28er2p1"};
   TTreeReaderValue<Bool_t> L1_Mu22er2p1_IsoTau30er2p1 = {fReader, "L1_Mu22er2p1_IsoTau30er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_Mu7_EG20er2p5 = {fReader, "L1_Mu7_EG20er2p5"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleEG28_FWD2p5 = {fReader, "L1_SingleEG28_FWD2p5"};
   TTreeReaderValue<Bool_t> L1_SingleEG28er1p5 = {fReader, "L1_SingleEG28er1p5"};
   TTreeReaderValue<Bool_t> L1_SingleEG28er2p1 = {fReader, "L1_SingleEG28er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleEG28er2p5 = {fReader, "L1_SingleEG28er2p5"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleIsoEG28_FWD2p5 = {fReader, "L1_SingleIsoEG28_FWD2p5"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleIsoTau32er2p1 = {fReader, "L1_SingleIsoTau32er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleJet140er2p5_ETMHF70 = {fReader, "L1_SingleJet140er2p5_ETMHF70"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleLooseIsoEG26er1p5 = {fReader, "L1_SingleLooseIsoEG26er1p5"};
   TTreeReaderValue<Bool_t> L1_SingleLooseIsoEG26er2p5 = {fReader, "L1_SingleLooseIsoEG26er2p5"};
   TTreeReaderValue<Bool_t> L1_SingleLooseIsoEG28_FWD2p5 = {fReader, "L1_SingleLooseIsoEG28_FWD2p5"};
   TTreeReaderValue<Bool_t> L1_SingleLooseIsoEG28er1p5 = {fReader, "L1_SingleLooseIsoEG28er1p5"};
   TTreeReaderValue<Bool_t> L1_SingleLooseIsoEG28er2p1 = {fReader, "L1_SingleLooseIsoEG28er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleLooseIsoEG28er2p5 = {fReader, "L1_SingleLooseIsoEG28er2p5"};
   TTreeReaderValue<Bool_t> L1_SingleLooseIsoEG30er1p5 = {fReader, "L1_SingleLooseIsoEG30er1p5"};
   TTreeReaderValue<Bool_t> L1_SingleLooseIsoEG30er2p5 = {fReader, "L1_SingleLooseIsoEG30er2p5"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleMu22_DQ = {fReader, "L1_SingleMu22_DQ"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleMu22_OQ = {fReader, "L1_SingleMu22_OQ"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleMuShower_Nominal = {fReader, "L1_SingleMuShower_Nominal"};
   TTreeReaderValue<Bool_t> L1_SingleMuShower_Tight = {fReader, "L1_SingleMuShower_Tight"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleTau70er2p1 = {fReader, "L1_SingleTau70er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_TripleMu_2SQ_1p5SQ_0OQ = {fReader, "L1_TripleMu_2SQ_1p5SQ_0OQ"};
   TTreeReaderValue<Bool_t> L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12 = {fReader, "L1_TripleMu_2SQ_1p5SQ_0OQ_Mass_Max12"};
   TTreeReaderValue<Bool_t> L1_TripleMu_3SQ_2p5SQ_0OQ_Mass_Max12 = {fReader, "L1_TripleMu_3SQ_2p5SQ_0OQ_Mass_Max12"};
   ...
   TTreeReaderValue<Bool_t> HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS30_Trk1_eta2p1_Reg_CrossL1 = {fReader, "HLT_IsoMu24_eta2p1_MediumChargedIsoPFTauHPS30_Trk1_eta2p1_Reg_CrossL1"};
   TTreeReaderValue<Bool_t> HLT_IsoMu27_LooseChargedIsoPFTau20_Trk1_eta2p1_SingleL1 = {fReader, "HLT_IsoMu27_LooseChargedIsoPFTau20_Trk1_eta2p1_SingleL1"};
   ...
   TTreeReaderValue<Bool_t> HLT_L1SingleMuCosmics = {fReader, "HLT_L1SingleMuCosmics"};
   ...
   TTreeReaderValue<Bool_t> HLT_CaloMET300_NotCleaned = {fReader, "HLT_CaloMET300_NotCleaned"};
   TTreeReaderValue<Bool_t> HLT_CaloMET350_NotCleaned = {fReader, "HLT_CaloMET350_NotCleaned"};
   TTreeReaderValue<Bool_t> HLT_PFMET200_NotCleaned = {fReader, "HLT_PFMET200_NotCleaned"};
   TTreeReaderValue<Bool_t> HLT_PFMET250_NotCleaned = {fReader, "HLT_PFMET250_NotCleaned"};
   TTreeReaderValue<Bool_t> HLT_PFMET300_NotCleaned = {fReader, "HLT_PFMET300_NotCleaned"};
   TTreeReaderValue<Bool_t> HLT_PFMET200_BeamHaloCleaned = {fReader, "HLT_PFMET200_BeamHaloCleaned"};
   TTreeReaderValue<Bool_t> HLT_PFMETTypeOne200_BeamHaloCleaned = {fReader, "HLT_PFMETTypeOne200_BeamHaloCleaned"};
   ...
   TTreeReaderValue<Bool_t> HLT_PFHT400_FivePFJet_100_100_60_30_30 = {fReader, "HLT_PFHT400_FivePFJet_100_100_60_30_30"};
   TTreeReaderValue<Bool_t> HLT_PFHT400_FivePFJet_100_100_60_30_30_DoublePFBTagDeepCSV_4p5 = {fReader, "HLT_PFHT400_FivePFJet_100_100_60_30_30_DoublePFBTagDeepCSV_4p5"};
   TTreeReaderValue<Bool_t> HLT_PFHT400_FivePFJet_120_120_60_30_30_DoublePFBTagDeepCSV_4p5 = {fReader, "HLT_PFHT400_FivePFJet_120_120_60_30_30_DoublePFBTagDeepCSV_4p5"};
   ...
   TTreeReaderValue<Bool_t> HLT_CDC_L2cosmic_10_er1p0 = {fReader, "HLT_CDC_L2cosmic_10_er1p0"};
   ...
   TTreeReaderValue<Bool_t> HLT_DoubleMediumChargedIsoPFTauHPS30_L1MaxMass_Trk1_eta2p1_Reg = {fReader, "HLT_DoubleMediumChargedIsoPFTauHPS30_L1MaxMass_Trk1_eta2p1_Reg"};
   ...
   TTreeReaderValue<Bool_t> HLT_VBF_DoubleLooseChargedIsoPFTau20_Trk1_eta2p1 = {fReader, "HLT_VBF_DoubleLooseChargedIsoPFTau20_Trk1_eta2p1"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu12_IP6_ToCSCS = {fReader, "HLT_Mu12_IP6_ToCSCS"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu9_IP5_ToCSCS = {fReader, "HLT_Mu9_IP5_ToCSCS"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu7_IP4_ToCSCS = {fReader, "HLT_Mu7_IP4_ToCSCS"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu9_IP4_ToCSCS = {fReader, "HLT_Mu9_IP4_ToCSCS"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu8_IP5_ToCSCS = {fReader, "HLT_Mu8_IP5_ToCSCS"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu8_IP6_ToCSCS = {fReader, "HLT_Mu8_IP6_ToCSCS"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu9_IP6_ToCSCS = {fReader, "HLT_Mu9_IP6_ToCSCS"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu8_IP3_ToCSCS = {fReader, "HLT_Mu8_IP3_ToCSCS"};
   ...
   TTreeReaderValue<Bool_t> HLT_Mu9_IP0_part0 = {fReader, "HLT_Mu9_IP0_part0"};
   TTreeReaderValue<Bool_t> HLT_Mu9_IP3_part0 = {fReader, "HLT_Mu9_IP3_part0"};
   ...
   TTreeReaderValue<Bool_t> HLT_PPSMaxTracksPerArm1 = {fReader, "HLT_PPSMaxTracksPerArm1"};
   TTreeReaderValue<Bool_t> HLT_PPSMaxTracksPerRP4 = {fReader, "HLT_PPSMaxTracksPerRP4"};
